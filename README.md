...
It includes `@mui/material` and its peer dependencies, including `joy`, the default style engine in MUI v5. If you prefer, you can [use styled-components instead](https://mui.com/material-ui/guides/interoperability/#styled-components).
It includes the date-picker package. instructions for instalation fonud at https://mui.com/x/react-date-pickers/getting-started/#typescript
